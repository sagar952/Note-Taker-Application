...
import com.todo.connection.FactoryProvider;
...
public class EditServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //update now in the session
        NoteDao dao=new NoteDao(FactoryProvider.getFactory());
       boolean f=dao.editNote(id, title, content);
       HttpSession  s=request.getSession();
       if(f)
        {
           s.setAttribute("message", "Sucessfully Note Updated!!!");
